...
optimizer = tf.train.GradientDescentOptimizer(learning_rate=0.454)
...
# epoch =  0018 loss =  0.308266072
# epoch =  0019 loss =  0.307343465
# epoch =  0020 loss =  0.308106930
# epoch =  0021 loss =  0.307936592
# accuracy =  0.9197
# label =  [2]
# prediction =  [2]
